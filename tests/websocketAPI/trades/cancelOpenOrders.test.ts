...
describe('Cancel Open Orders', () => {
    ...
    const callbacks = {
        open: (client: WebsocketAPI) => client.cancelOpenOrders('BNBUSDT'),
    ...
    it('should cancel all open orders on a symbol, including OCO orders', async () => {
        resultTemplate.data = mockCancelOpenOrders;
