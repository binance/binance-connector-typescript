...
describe('Cancel OCO Order', () => {
    let responseMessage: WebSocket.Data = '';
    let server: http.Server;
    const callbacks = {
        open: (client: WebsocketAPI) => client.cancelOCOOrder('BNBUSDT', 12730),
    ...
    it('should cancel an active OCO', async () => {
        resultTemplate.data = mockCancelOCOOrder;
