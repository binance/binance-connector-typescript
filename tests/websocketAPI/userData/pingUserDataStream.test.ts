...
describe('Ping User Data Stream', () => {
    let responseMessage: WebSocket.Data = '';
    let server: http.Server;
    const callbacks = {
        open: (client: WebsocketAPI) => client.pingUserDataStream('xs0mRXdAKlIPDRFrlPcw0qI41Eh3ixNntmymGyhrhgqo7L6FuLaWArTD7RLP'),
    ...
    it('should ping a user data stream to keep it alive', async () => {
